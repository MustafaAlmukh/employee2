          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text('هو أحد موظفي [ مصلحة الاحوال المدنية ] , ويتقاضي مرتبا شهريا بياناته موضحة كما يلي :  ', style: TextStyle(fontSize: 10)),
                  ],
                ),
                SizedBox(height: 10,),
                Row(
                  ...
                  children: [
                    Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        Text('استخرجت هذه الشهادة بناء علي طلبه من واقع مرتبه عن شهر 4 لسنة 2024 ', style: TextStyle(fontSize: 10),maxLines: 2,),
